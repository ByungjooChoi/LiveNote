...
enum RecipeRunner {
    ...
    nonisolated static let contextBudget = 120_000
    nonisolated static let perMeetingTranscriptCap = 6_000
    ...
    struct Backend: Sendable {
        ...
        static func live(apiKey: @escaping @MainActor @Sendable () -> String?) -> Backend {
            Backend(
                apiKey: apiKey,
